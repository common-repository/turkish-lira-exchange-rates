...
class Turkish_Lira_Widget extends WP_Widget {
	function __construct() {
		...
		/* Create the widget. */
		parent::__construct( 'turkish-lira-widget', 'Turkish Lira Widget', $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		if ( $add_CSS )
			echo '
<style type="text/css">
#iwit_currency {margin:0 auto;background: #fff; color: #000;padding: 0;}
#iwit_currency div.c_header {clear:both;}
#iwit_currency div.c_row{font-size:1rem;padding:.2rem;font-weight:normal;clear:both;overflow: hidden;line-height:1;}
#iwit_currency div.odd {background:#efefef;}
#iwit_currency div.c_row .c_symbol{float:left;padding-left:20px;background:transparent no-repeat scroll 0 center;}
#iwit_currency div.difi{background:#efefef;}
#iwit_currency div.c_row div.c_rate{float: right;overflow: hidden;padding: 0;text-align: left;width: 25%;}
#iwit_currency div.c_header div.c_rate{min-width:50px;float:right;text-align:left;font-weight:bold;padding:0px;width: 25%;}
#iwit_currency div.c_row .AUD{background-image:url(wp-content/plugins/turkish-lira-exchange-rates/AUD.gif);}
#iwit_currency div.c_row .CAD{background-image:url(wp-content/plugins/turkish-lira-exchange-rates/CAD.gif);}
#iwit_currency div.c_row .CHF{background-image:url(wp-content/plugins/turkish-lira-exchange-rates/CHF.gif);}
#iwit_currency div.c_row .DKK{background-image:url(wp-content/plugins/turkish-lira-exchange-rates/DKK.gif);}
#iwit_currency div.c_row .EUR{background-image:url(wp-content/plugins/turkish-lira-exchange-rates/EUR.gif);}
#iwit_currency div.c_row .GBP{background-image:url(wp-content/plugins/turkish-lira-exchange-rates/GBP.gif);}
#iwit_currency div.c_row .JPY{background-image:url(wp-content/plugins/turkish-lira-exchange-rates/JPY.gif);}
#iwit_currency div.c_row .KWD{background-image:url(wp-content/plugins/turkish-lira-exchange-rates/KWD.gif);}
#iwit_currency div.c_row .NOK{background-image:url(wp-content/plugins/turkish-lira-exchange-rates/NOK.gif);}
#iwit_currency div.c_row .SAR{background-image:url(wp-content/plugins/turkish-lira-exchange-rates/SAR.gif);}
#iwit_currency div.c_row .SEK{background-image:url(wp-content/plugins/turkish-lira-exchange-rates/SEK.gif);}
#iwit_currency div.c_row .USD{background-image:url(wp-content/plugins/turkish-lira-exchange-rates/USD.gif);}
#iwit_currency div.c_credit{font-size:0.9em;color:#999;clear:both;text-align:center;font-weight:bold;display:none;}
#iwit_currency div.c_credit a{color:#369;clear:both;text-align:center;font-weight:bold;}
</style>';
...
if ($rates == false) {
	...
	foreach($xml->Currency as $Currency) {
		...
		echo '<div id="iwit_currency"><div class="c_header"><div class="c_rate">';
		if ( $sellLabel )
			echo '' . $sellLabel . '';
